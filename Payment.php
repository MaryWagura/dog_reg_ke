...
$res = $connection->query("SELECT DogLicenseNumber FROM petdetails where OwnerID='$OwnerID' ") or die("Failed to query DB" . mysqli_error($conn));
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="pay.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" value="<?php echo $FirstName; ?>" required readonly><br><br>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="DogLicenseNumber" value=" KEN <?php echo $row['DogLicenseNumber']; ?>" required readonly><br><br>
